...
/obj/item/weapon/reagent_containers/glass/bottle/antitoxin
	...
	list_reagents = list("antitoxin" = volume)
...
/obj/item/weapon/reagent_containers/glass/bottle/cryoxadone
	...
	list_reagents = list("cryoxadone" = volume)
...
/obj/item/weapon/reagent_containers/glass/bottle/tuberculosiscure
	...
	list_reagents = list("atropine" = volume/6, "epinephrine" = volume/6, "salbutamol" = volume/3, "spaceacillin" = volume/3)
