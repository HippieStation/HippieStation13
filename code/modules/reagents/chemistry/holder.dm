...
/datum/reagents/proc/add_reagent_list_fill(list/list_reagents_fill) // Like add_reagent_list but you it adds equal parts of each in the list to evenly fill the container.
